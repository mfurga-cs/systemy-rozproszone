	...
	public void testProto() throws IOException
	{
		Person p1 =
				  Person.newBuilder()
					...
					.addSalaries(Person.Salary.newBuilder().setSalary(7000.0f))
					.addSalaries(Person.Salary.newBuilder().setSalary(5000.0f))
						  .addSalaries(Person.Salary.newBuilder().setSalary(4000.0f))
